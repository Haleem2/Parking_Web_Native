        ...
        <div class="col-lg-8 col-md-12 col-xs-12">
          ...
          <h4 class="text-center">Rent Ticket</h4>
            ...
            <div class="col-12 text-center">
                      <span>
                        <strong>Your Satisfaction is Our Target</strong></span>
                    </div>
                </div>
            </div>
            <?php
              $qrcode= $row['rentno'];
                ...
                if(isset($_POST["btnconfirm"]))
                {
                  ...
                  $PNG_TEMP_DIR = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'temp/rent/' . DIRECTORY_SEPARATOR;

                  //html PNG location prefix
                  $PNG_WEB_DIR = 'temp/rent/';
