...
class Car_Owner extends Database implements operations 
{
 ...
 public function updatenationalidandphoto(){

    return parent::RunDML("update `car owner` SET `nationalid` = '".$this->Getnationalid()."', `Photo_Name` = '".$this->GetphotoName()."' WHERE `Owner_Id`= '".$this->GetID()."'");
 }
   ...
   public function Add(){
      ...
      return parent::RunDML("insert into `car owner` values (Default,'".$this->GetName().
      "','".sha1($this->GetPassword())."','"
      .$this->GetPhoneNum()."','"
      .$this->GetAddress()."','"
      .$this->GetEmail()."', Default, Default )");
   }

   public function AddCar(){

    return parent::RunDML("insert into `car numbers` values ('".$this->GetCarNum()."','"
    .$this->GetCarColor()."','"
    .$this->GetCarLicesnse().
    "','".$this->GetCarType().
    "','".$this->GetID()."', Default)");
    ...
    public function UpdateProfile(){
        ...
        return parent::RunDML("update  `viewcarowner` set Name='".$this->GetName().
        "', Phone_Number='".$this->GetPhoneNum().
   ...
   public function Update(){
       ...
       return parent::RunDML("update `car owner` set  Password='".sha1($this->GetPassword()).
       "' where Owner_Id='".$this->GetID()."' ");
