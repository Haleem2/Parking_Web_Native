    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a href="indexuser.php" class="navbar-brand logo"><img src="assets/img/logo.png" alt=""></a>
        </div>
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav mr-auto w-100 justify-content-center">
            <li class="nav-item dropdown active">
              <a class="nav-link " href="indexUser.php" aria-haspopup="true"
                aria-expanded="false">
                Home
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="delivery1.php">
                Delivery
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="rent1.php">
                Rent
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="contactuser.php">
                Contact
              </a>
            </li>
          </ul>
