           ...
           echo("<h3 class='alert alert-danger'> Sorry this mail is used</h3>");
                  ...
                  <td colspan="2" style="text-align:center">
                    <div class="profilephoto">
                                  ...
                                  <div id="profilephotohover" class="rounded-circle" style=" background-color: rgba(0, 0, 0, 0.4); "><div id="btnUpload" style=" display: block; "><hr>Change Photo <i class="fas fa-camera"></i></div></div>
